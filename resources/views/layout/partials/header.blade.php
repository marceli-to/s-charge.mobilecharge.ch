  ...
  <div>
    ...
    <nav class="user-menu">
      <a href="javascript:;" class="btn-language js-language-menu-btn" title="{{ __('Menü') }}">
        <img src="/assets/mobilecharge/img/flag-{{app()->getLocale()}}.svg" height="12" width="16" alt="Deutsch">
        <span>{{ app()->getLocale() }}</span>
      </a>
      <a href="https://cloud.mobilecharge.ch/csp/?cbr=76d360009d69c39b65bf46218f11" target="_blank" rel="noopener" class="btn-login">
      ...
      <div>
        <div>
          ...
          <ul>
            ...
            @if (request()->routeIs('*page_project*'))
              <li>
                <a href="/de/projekte" class="{{ app()->getLocale() == 'de' ? 'is-active' : '' }}" title="Deutsch">
                  <img src="/assets/mobilecharge/img/flag-de.svg" height="12" width="16" alt="Deutsch">
                  <span>Deutsch</span>
                </a>
              </li>
              <li>
                <a href="/en/projects" class="{{ app()->getLocale() == 'en' ? 'is-active' : '' }}" title="English">
                  <img src="/assets/mobilecharge/img/flag-en.svg" height="12" width="16" alt="English">
                  <span>English</span>
                </a>
              </li>
              <li>
                <a href="/fr/projets" class="{{ app()->getLocale() == 'fr' ? 'is-active' : '' }}" title="Francais">
                  <img src="/assets/mobilecharge/img/flag-fr.svg" height="12" width="16" alt="Francais">
                  <span>Français</span>
                </a>
              </li>
              <li>
                <a href="/it/progetti" class="{{ app()->getLocale() == 'it' ? 'is-active' : '' }}" title="Italiano">
                  <img src="/assets/mobilecharge/img/flag-it.svg" height="12" width="16" alt="Italiano">
                  <span>Italiano</span>
                </a>
              </li>
            @elseif (request()->routeIs('*page_commissioning'))
              <li>
                <a href="/de/inbetriebnahme-formular" class="{{ app()->getLocale() == 'de' ? 'is-active' : '' }}" title="Deutsch">
                  <img src="/assets/mobilecharge/img/flag-de.svg" height="12" width="16" alt="Deutsch">
                  <span>Deutsch</span>
                </a>
              </li>
              <li>
                <a href="/en/commissioning-form" class="{{ app()->getLocale() == 'en' ? 'is-active' : '' }}" title="English">
                  <img src="/assets/mobilecharge/img/flag-en.svg" height="12" width="16" alt="English">
                  <span>English</span>
                </a>
              </li>
              <li>
                <a href="/fr/formulaire-de-mise-en-service" class="{{ app()->getLocale() == 'fr' ? 'is-active' : '' }}" title="Francais">
                  <img src="/assets/mobilecharge/img/flag-fr.svg" height="12" width="16" alt="Francais">
                  <span>Français</span>
                </a>
              </li>
              <li>
                <a href="/it/modulo-di-messa-in-servizio" class="{{ app()->getLocale() == 'it' ? 'is-active' : '' }}" title="Italiano">
                  <img src="/assets/mobilecharge/img/flag-it.svg" height="12" width="16" alt="Italiano">
                  <span>Italiano</span>
                </a>
              </li>
            @else
              <li>
                @if (request()->routeIs('*page_index'))
                  <a href="/de/" class="{{ app()->getLocale() == 'de' ? 'is-active' : '' }}" title="Deutsch">
                    <img src="/assets/mobilecharge/img/flag-de.svg" height="12" width="16" alt="Deutsch">
                    <span>Deutsch</span>
                  </a>
                @else
                  <a href="{{ current_route('de') }}" class="{{ app()->getLocale() == 'de' ? 'is-active' : '' }}" title="Deutsch">
                    <img src="/assets/mobilecharge/img/flag-de.svg" height="12" width="16" alt="Deutsch">
                    <span>Deutsch</span>
                  </a>
                @endif
              ...
              <li>
                ...
                @else
                  <a href="{{ current_route('en') }}" class="{{ app()->getLocale() == 'en' ? 'is-active' : '' }}" title="English">
                    <img src="/assets/mobilecharge/img/flag-en.svg" height="12" width="16" alt="English">
                    <span>English</span>
                  </a>
                @endif
              ...
              <li>
                @if (request()->routeIs('*page_index'))
                  <a href="/fr/" class="{{ app()->getLocale() == 'fr' ? 'is-active' : '' }}" title="Français">
                    <img src="/assets/mobilecharge/img/flag-fr.svg" height="12" width="16" alt="Français">
                    <span>Français</span>
                  </a>
                @else
                  <a href="{{ current_route('fr') }}" class="{{ app()->getLocale() == 'fr' ? 'is-active' : '' }}" title="Français">
                    <img src="/assets/mobilecharge/img/flag-fr.svg" height="12" width="16" alt="Français">
                    <span>Français</span>
                  </a>
                @endif
              ...
              <li>
                ...
                @else
                  <a href="{{ current_route('it') }}" class="{{ app()->getLocale() == 'it' ? 'is-active' : '' }}" title="Italiano">
                    <img src="/assets/mobilecharge/img/flag-it.svg" height="12" width="16" alt="Italiano">
                    <span>Italiano</span>
                  </a>
                @endif
